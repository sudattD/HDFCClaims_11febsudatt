...
public class DocumentUploadSurveyFeesBillAdapter extends BaseAdapter {
    ...
    public DocumentUploadSurveyFeesBillAdapter(Activity activity, ArrayList<String> listImages) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        final View view = inflater.inflate(R.layout.document_upload_survey_fees_bill_item, parent, false);
