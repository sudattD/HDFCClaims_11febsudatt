...
/**
 * Created by patelmih on 1/12/2016.
 */
...
public class DocumentUploadNewCategoryAdapter extends BaseAdapter {
    ...
    public DocumentUploadNewCategoryAdapter(Activity activity, ArrayList<String> listImages) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        final View view = inflater.inflate(R.layout.document_upload_new_category_item, parent, false);
