...
/**
 * Created by patelmih on 1/11/2016.
 */
...
public class DocumentUploadCancelledChequeAdapter extends BaseAdapter {
    ...
    private HorizontalListView idemnityListViewImages;

    public DocumentUploadCancelledChequeAdapter(Activity activity, ArrayList<String> listImages) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        final View view = inflater.inflate(R.layout.document_upload_cancelled_cheque_item, parent, false);

        holder.imageView = (ImageView) view.findViewById(R.id.imgView);
        //holder.idemnityListViewImages = (HorizontalListView) view.findViewById(R.id.listViewIdemnityImages);
            ...
            public boolean onLongClick(View arg0) {
                ...
                alert.setPositiveButton("YES", new OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        //holder.idemnityListViewImages.setVisibility(View.GONE);
                    }
                });
