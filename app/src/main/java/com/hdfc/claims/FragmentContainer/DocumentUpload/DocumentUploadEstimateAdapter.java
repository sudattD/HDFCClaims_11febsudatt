...
public class DocumentUploadEstimateAdapter extends BaseAdapter {
    ...
    public DocumentUploadEstimateAdapter(Activity activity, ArrayList<String> listImages) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        final View view = inflater.inflate(R.layout.document_upload_estimate_item, parent, false);
