...
public class DocumentUploadRegistrationCopyAdapter extends BaseAdapter {
    ...
    public DocumentUploadRegistrationCopyAdapter(Activity activity, ArrayList<String> listImages) {
    ...
    public class Holder
    {
        ...
        ImageView imageView;
        public HorizontalScrollView licenceListViewImages;
    }
    @Override
    public int getCount() {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        final View view = inflater.inflate(R.layout.document_upload_registration_copy_item, parent, false);

        holder.imageView = (ImageView) view.findViewById(R.id.imgView);
        holder.licenceListViewImages = (HorizontalScrollView) view.findViewById(R.id.listViewRegistrationCopyImages);
        view.setTag(holder);
            ...
            public boolean onLongClick(View arg0) {
                ...
                alert.setPositiveButton("YES", new OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        //holder.licenceListViewImages.setVisibility(View.GONE);
