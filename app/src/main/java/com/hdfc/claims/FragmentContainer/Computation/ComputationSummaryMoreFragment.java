...
import com.hdfc.claims.FragmentContainer.NEFTEntryFragment;
...
public class ComputationSummaryMoreFragment extends Fragment {
  ...
  /*  private TextView part_selection_badge;
    ...
    private Button less_view_btn;


    public ComputationSummaryMoreFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_computation_summary_more, container, false);
    ...
    private void initializeControls() {
      ...
      /*  part_selection_badge = (TextView) view.findViewById(R.id.part_selection_badge);
        ...
        less_view_btn = (Button)view.findViewById(R.id.less_view_btn);

        less_view_btn.setOnClickListener(new View.OnClickListener() {
            @Override
