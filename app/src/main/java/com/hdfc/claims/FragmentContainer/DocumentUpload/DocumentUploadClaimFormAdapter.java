...
public class DocumentUploadClaimFormAdapter extends BaseAdapter {
    ...
    public DocumentUploadClaimFormAdapter(Activity activity, ArrayList<String> listImages) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        final View view = inflater.inflate(R.layout.document_upload_claim_form_item, parent, false);
