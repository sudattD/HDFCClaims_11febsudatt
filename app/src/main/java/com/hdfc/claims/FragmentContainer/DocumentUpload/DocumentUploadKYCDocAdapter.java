...
public class DocumentUploadKYCDocAdapter extends BaseAdapter {
    ...
    public DocumentUploadKYCDocAdapter(Activity activity, ArrayList<String> listImages) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        final View view = inflater.inflate(R.layout.document_upload_kyc_docs_item, parent, false);
