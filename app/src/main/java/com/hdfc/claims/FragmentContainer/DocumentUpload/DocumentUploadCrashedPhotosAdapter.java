...
public class DocumentUploadCrashedPhotosAdapter extends BaseAdapter {
    ...
    public DocumentUploadCrashedPhotosAdapter(Activity activity, ArrayList<String> listImages) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        final View view = inflater.inflate(R.layout.document_upload_crash_photos_item, parent, false);
