...
public class DocumentUploadRepairBillAdapter extends BaseAdapter {
    ...
    public DocumentUploadRepairBillAdapter(Activity activity, ArrayList<String> listImages) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        final View view = inflater.inflate(R.layout.document_upload_repair_bill_item, parent, false);
